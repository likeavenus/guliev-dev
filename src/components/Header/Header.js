                ...
                <nav className={styles.header_nav}>
                    <ul className={styles.header_list}>
                        <li className={styles.header_item}>
                            <Link className={styles.header_link} onClick={this.handleToggleBurgerMenu} to={'/'}>Главная</Link>
                        </li>
                        <li className={styles.header_item}>
                            <Link className={styles.header_link} onClick={this.handleToggleBurgerMenu} to={'/about'}>Обо мне</Link>
                        </li>
                        <li className={styles.header_item}>
                            <Link className={styles.header_link} onClick={this.handleToggleBurgerMenu} to={'/portfolio'}>Работы</Link>
                        </li>
                    </ul>
                </nav>
            );
